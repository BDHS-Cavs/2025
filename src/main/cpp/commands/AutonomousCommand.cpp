...
AutonomousCommand::AutonomousCommand(Drivetrain* m_swerve, Climber* m_climber, Shooter* m_shooter, Intake* m_intake, Conveyer* m_conveyer)
:m_swerve(m_swerve),
m_climber(m_climber),
m_shooter(m_shooter),
m_intake(m_intake),
...
void AutonomousCommand::Execute() {
    ...
    else if(m_timer.Get() >= period3 && m_timer.Get() < period4) //starts at 5 ends at 6 (1s)
    {
        ...
        //TODO replace //TODO m_swerve->calculateVectors(1, 1, 1);
    }
